...
This project was developed through the google collab notebook, so to run it, just access the link below and run the algorithm directly on the collab notebook. Remember to use the same account that was used to open the spreadsheet:
...
Pay attention!!!  You don't need to install any feature to run the code, just run it.
